...
import { Mic, MessageSquare, AlertCircle, RotateCcw } from "lucide-react"
      ...
      <div className="mb-3 rounded-xl border-2 border-amber-200 bg-amber-50 px-4 py-3">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-semibold text-amber-900">Voice mode unavailable</p>
            <p className="text-xs text-amber-700 mt-1 leading-relaxed">
              {failureReason || "We couldn't access your microphone after multiple attempts."}
            </p>
