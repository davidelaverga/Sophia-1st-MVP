...
export function PresenceIndicator() {
  ...
  return (
    <div className="flex items-center gap-2 text-sm text-sophia-text2" aria-live="polite">
      <span
        className={`h-2.5 w-2.5 rounded-full ${stageAccent[stage] ?? stageAccent.resting} motion-safe:animate-pulse`}
      />
      <span>{label}</span>
