...
export function FeedbackStrip({ turnId }: FeedbackStripProps) {
  ...
  return (
    <div className="mt-3 rounded-2xl border border-sophia-text/10 bg-white/80 px-3 py-2 text-sm text-sophia-text">
      {!submitted ? (
              ...
              <button
                ...
                className={`rounded-full border px-3 py-1 text-xs transition ${
                  selectedTag === tag.id
                    ...
                    : "border-sophia-text/20 bg-white text-sophia-text"
                }`}
                disabled={submitting}
                onClick={() => {
